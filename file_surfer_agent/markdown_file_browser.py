# https://github.com/microsoft/autogen/blob/main/python/packages/autogen-ext/src/autogen_ext/agents/file_surfer/_markdown_file_browser.py
...
class MarkdownFileBrowser:
    ...
    def __init__(  # type: ignore
        self,
        viewport_size: Union[int, None] = 1024, # Higher viewport sizes seemed to cause confusion for llama 3
